...
<head>
    <meta charset="UTF-8">
    <title>NoiseBuster Documentation</title>
    <style>
        body {
...
<body>
    ...
    <ol>
        <li>Clone the repository using Git:
            <div style="position: relative; margin-top: 10px; margin-bottom: 10px;">
                ...
                <button class="copy-button" onclick="copyToClipboard('git clone https://github.com/silkyclouds/NoiseBuster.git')" aria-label="Copy code">
                    <!-- Copy Icon SVG -->
            ...
            <div style="position: relative; margin-top: 10px; margin-bottom: 10px;">
                ...
                <button class="copy-button" onclick="copyToClipboard('cd NoiseBuster')" aria-label="Copy code">
                    <!-- Copy Icon SVG -->
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path d="M16 1H4a2 2 0 0 0-2 2v14h2V3h12V1zm3 4H8a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zm0 16H8V7h11v14z"/>
                    </svg>
        ...
        <li>Build the Docker image:
            <div style="position: relative; margin-top: 10px; margin-bottom: 10px;">
                ...
                <button class="copy-button" onclick="copyToClipboard('docker build -t noisebuster .')" aria-label="Copy code">
                    <!-- Copy Icon SVG -->
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path d="M16 1H4a2 2 0 0 0-2 2v14h2V3h12V1zm3 4H8a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zm0 16H8V7h11v14z"/>
                    </svg>
        ...
        <li>Run the Docker container:
            <div style="position: relative; margin-top: 10px; margin-bottom: 10px;">
                ...
                <button class="copy-button" onclick="copyToClipboard('docker run -d --name noisebuster -p 8086:8086 -p 3000:3000 noisebuster')" aria-label="Copy code">
                    <!-- Copy Icon SVG -->
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path d="M16 1H4a2 2 0 0 0-2 2v14h2V3h12V1zm3 4H8a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zm0 16H8V7h11v14z"/>
                    </svg>
    ...
    <ol>
        ...
        <div style="position: relative; margin-top: 10px; margin-bottom: 10px;">
            ...
            <button class="copy-button" onclick="copyToClipboard('docker-compose up -d')" aria-label="Copy code">
                <!-- Copy Icon SVG -->
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M16 1H4a2 2 0 0 0-2 2v14h2V3h12V1zm3 4H8a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zm0 16H8V7h11v14z"/>
                </svg>
...
devices:
  - "/dev/bus/usb/003/011:/dev/bus/usb/003/011"
                    ...
                    <button class="copy-button" onclick="copyToClipboard('/dev/bus/usb/003/011:/dev/bus/usb/003/011')" aria-label="Copy code">
                        <!-- Copy Icon SVG -->
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path d="M16 1H4a2 2 0 0 0-2 2v14h2V3h12V1zm3 4H8a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zm0 16H8V7h11v14z"/>
                        </svg>
        ...
        <div style="position: relative; margin-top: 10px; margin-bottom: 10px;">
            ...
            <button class="copy-button" onclick="copyToClipboard('docker-compose logs -f')" aria-label="Copy code">
                <!-- Copy Icon SVG -->
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M16 1H4a2 2 0 0 0-2 2v14h2V3h12V1zm3 4H8a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zm0 16H8V7h11v14z"/>
                </svg>
    ...
    <ol>
        ...
        <div style="position: relative; margin-top: 10px; margin-bottom: 10px;">
            ...
            <button class="copy-button" onclick="copyToClipboard('source env/bin/activate')" aria-label="Copy code">
                <!-- Copy Icon SVG -->
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M16 1H4a2 2 0 0 0-2 2v14h2V3h12V1zm3 4H8a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zm0 16H8V7h11v14z"/>
                </svg>
        ...
        <div style="position: relative; margin-top: 10px; margin-bottom: 10px;">
            ...
            <button class="copy-button" onclick="copyToClipboard('python noisebuster.py')" aria-label="Copy code">
                <!-- Copy Icon SVG -->
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M16 1H4a2 2 0 0 0-2 2v14h2V3h12V1zm3 4H8a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2zm0 16H8V7h11v14z"/>
                </svg>
